...
int main(int argc, char *argv[]) {
    Mat img1 = imread("<project_directory>/samples/data/box.png",
                      IMREAD_GRAYSCALE); // TODO change to your project directory
    Mat img2 = imread("<project_directory/samples/data/box_in_scene.png",
                      IMREAD_GRAYSCALE); //TODO change to your project directory
